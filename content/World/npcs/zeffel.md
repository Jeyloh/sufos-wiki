...
race: Tiefling
status: alive
disposition: friendly (employer)
first_met: Session 3 — Zeffel's establishment
tags: [copper-ring, merchant, employer, emberstone, major-npc]
---

# Zeffel

**Tiefling merchant, Copper Ring**

## Description

A powerful Tiefling merchant and member of the Copper Ring (Emberstone's ruling merchant class). Runs his own establishment in the city and has a vast network of informants and paid guards.

## Relationship

Primary employer in Emberstone. Has spent large sums in bribes to keep the party out of trouble. Wants [[kynos-gruun|Kynos Gruun]] removed and offers the party a path to Copper Lord status.
